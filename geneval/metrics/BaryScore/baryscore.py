...
Args:
    ...
    use_idfs: Boolean whether to use IDF costs or uniform costs
Returns:
...
class BaryScore(datasets.Metric):
    ...
    def _compute(self, predictions, references):
        ...
        metric_call.prepare_idfs(hyps = predictions, refs= references)
        final_preds = metric_call.evaluate_batch(batch_hyps=predictions, batch_refs= references)
        return final_preds
